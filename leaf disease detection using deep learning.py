...
MainWindow.title("Leaf Disease Detector by Vishu , Pratyush and Shruti")

S = tkinter.Scale(MainWindow, from_=0, to=100, length=800, orient=tkinter.HORIZONTAL,
                  background='white', fg='black', troughcolor='white', label="Detection of Disease in Leaf")
S.pack()
S.set(150)
